        ...
        >
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/monty16597" target='_blank' rel="noreferrer" className="w-10 h-10 rounded-lg bg-glass-secondary hover:bg-glass-accent transition-colors duration-300 flex items-center justify-center">
              ...
              <a href="https://www.linkedin.com/in/manjeetsinh-alonja/" target='_blank' rel="noreferrer" className="w-10 h-10 rounded-lg bg-glass-secondary hover:bg-glass-accent transition-colors duration-300 flex items-center justify-center">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
